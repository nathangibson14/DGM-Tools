...
! call sn_solver(xs,(/200,200,200/),(/0._8,0.125_8,1.125_8,1.25_8/),(/1,2,1/),8,BC,1)

! write(*,*) 'starting dgm_sn... ', read_timer()
! call dgm_sn(xs,(/50,50,50/),(/0._8,0.125_8,1.125_8,1.25_8/),(/1,2,1/),8,BC,1)
! call dgm_sn(xs,(/(1,i=1,150)/),(/(real(i*1.25/150,kind=8),i=0,150)/), & 
    ! & (/(mod(i,2)+1,i=1,50),(mod(i,2)+1,i=1,50),(mod(i,2)+1,i=1,50)/),8,BC,1)
